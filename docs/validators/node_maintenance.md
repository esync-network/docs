...
2. **Slashing Protection**
   These files hold the information on which block have been already processed by your validator. This is important in oder to not reprocess some, which is considered as misbehaviour and might reusult in slashing. Thus you should also backup the following 2 files:
