...
The etherbase address can be set as described here: [node setup](/validators/personal_node_setup#start-the-ecredits-node), or by using the eCredits script (type "ecredits" and then select "3")
